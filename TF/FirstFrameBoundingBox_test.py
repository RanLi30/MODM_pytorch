...
def DoG(image):
    ...
    blobs_dog = blob_dog(image_gray, max_sigma=20, threshold=.16)  # U373-01 60 .12
...
def drawfirstbbox(FFBB):
    fop = open('/home/ran/Trails/germination/germination_merged/enh/firstframe1.txt', mode='w')
    ...
    for idx in range(0, len(FFBB)):
        ...
        '''
        gt1=open('/home/ran/Trails/germination/germination_merged/groundtruth_rect1.txt',mode='w')
        ...
        exec("gt" + idx1 + "=open('//home/ran/Trails/germination/germination_merged/germination" + idx1 + ".txt',mode='w')")
    ...
    cv2.imwrite('/home/ran/Trails/germination/germination_merged/enh/0000.jpg', image)
...
if __name__ == "__main__":
    image = cv2.imread('/home/ran/Trails/germination/germination_merged/enh/germination_merged0001.jpg')  # first frame jpg path
    bbox = DoG(image)
    drawfirstbbox(bbox)
