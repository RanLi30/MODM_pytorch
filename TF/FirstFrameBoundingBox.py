...
def DoG(image):    
    ...
    blobs_dog = blob_dog(image_gray, max_sigma=50, threshold=.14) #U373-01 60 .12
...
def drawfirstbbox(FFBB):
    fop=open('/home/ran/Trails/PhC-C2DH-U373/CODE/02/firstframe1.txt',mode='w')
    ...
    for idx in range(0,len(FFBB)): 
            ...
            exec("gt"+idx1+"=open('//home/ran/Trails/PhC-C2DH-U373/CODE/02/groundtruth_rect"+idx1+".txt',mode='w')")
    ...
    cv2.imwrite('//home/ran/Trails/PhC-C2DH-U373/CODE/02/firstframe.jpg',image)
